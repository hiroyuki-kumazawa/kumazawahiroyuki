...
<body>
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div
            ...
            <div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 615px;"></div>
            ...
            <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
                <div class="os-scrollbar-track">
                    <div class="os-scrollbar-handle" style="height: 45.3274%; transform: translate(0px, 0px);"></div>
                </div>
            </div>
